...
export function CampaignStatusCard({ status, paidCount, totalParticipants }: CampaignStatusCardProps) {
  ...
  return (
    <section id="servidor" className="py-6 sm:py-8">
        ...
        <div className="rounded-3xl border border-white/10 bg-[#121622]/90 p-6 sm:p-8 backdrop-blur-xl shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Status da Campanha</h3>
                <p className="text-xs text-gray-400">Etapa atual do financiamento do servidor</p>
              </div>
            </div>

            {/* Main Status Badge */}
            <div className={`inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-extrabold ${details.badgeBg}`}>
              {details.icon}
              <span>{details.title}</span>
            </div>
          </div>

          <p className="mt-5 text-sm text-gray-300 leading-relaxed font-medium">
            {details.description}
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            >
              ...
              <h4 className="mt-2 text-sm font-bold text-white">1. Em Arrecadação</h4>
              <p className="mt-1 text-xs text-gray-400">Pagamento manual das 11 cotas via PIX</p>
            </div>
            ...
            >
              ...
              <h4 className="mt-2 text-sm font-bold text-white">2. Meta Atingida</h4>
              <p className="mt-1 text-xs text-gray-400">Total de R$ 395,88 arrecadado</p>
            </div>
            ...
            >
              ...
              <h4 className="mt-2 text-sm font-bold text-white">3. VPS Contratada</h4>
              <p className="mt-1 text-xs text-gray-400">Servidor ativo por 12 meses</p>
            </div>
          </div>
        </div>
      </div>
